...
The flexio_spi_slave_edma_dspi_master example is configured to use FLEXIO D0, D1, D2 and D3 with PTC12, PTC13, PTC14 and PTC15 to simulate spi slave and communicate with a on board dspi master example, with pin connections below:
