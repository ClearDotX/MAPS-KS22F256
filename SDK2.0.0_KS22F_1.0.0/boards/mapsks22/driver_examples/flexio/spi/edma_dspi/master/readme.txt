...
The flexio_spi_master_edma_dspi_slave example is configured to use FLEXIO D0, D1, D2 and D3 with PTC12, PTC13, PTC14 and PTC15 to simulate spi master and communicate with a on board dspi slave, with pin connections below:
...
=====================
The MOSI pin should connect to MOSI pin on the slave board, the MISO pin should connect to the MISO pin on the slave board.
