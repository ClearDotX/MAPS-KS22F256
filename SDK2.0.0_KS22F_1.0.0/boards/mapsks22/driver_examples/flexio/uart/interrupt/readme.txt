...
To observe the execution log on serial port, PTC12 and PTC13 should connect to the USB-to-Serial connector plug on PC, open the related COM port on PC to monitor the execution log.
