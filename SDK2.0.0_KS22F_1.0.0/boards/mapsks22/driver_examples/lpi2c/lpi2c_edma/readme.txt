Overview
========
The LPI2C Example project is a demonstration program that uses the KSDK software to manipulate the Low Power Inter-Integrated Circuit in edma mode.
The example use the lpi2c0 as the master to send data in edma way to the slave lpi2c1. The slave will check the data it receives and shows the log.
