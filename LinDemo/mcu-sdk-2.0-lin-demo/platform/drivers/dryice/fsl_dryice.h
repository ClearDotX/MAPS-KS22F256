...
typedef struct _dryice_pin_config
{
    ...
    uint8_t glitchFilterWidth; /*! 6-bit value to configure number of clock edges the input must remain stable for to be
                                  passed through the glitch filter for the tamper pin */
    enum _dryice_glitch_filter_prescaler
        glitchFilterPrescaler; /*! selects the prescaler for the glit filter on tamper pin */
...
/*!
 * @brief Enable clock gate for the DryIce.
 *
...
/*!
 * @brief Disable clock the DryIce peripheral.
 *
 * This function disables glitch filters and active tampers
 * This function disables DryIce clock and prescaler in DryIce Control Register.
 * This function disables the clock gate for the DryIce peripheral.
 */
void DRYICE_Deinit(DRY_Type *base);

/*!
 * @brief Get default values for DryIce Control Register.
 *
 * This function fills the given structure with default values for the DryIce Control Register.
 * The default values are:
 * @code
 *     defaultConfig->innerClockAndPrescalerEnable
 *     defaultConfig->tamperForceSystemResetEnable
 *     defaultConfig->updateMode
 *     defaultConfig->clockSourceActiveTamper0
 *     defaultConfig->clockSourceActiveTamper1
 *     defaultConfig->tamperHysteresisSelect
 *     defaultConfig->tamperPassiveFilterEnable
 *     defaultConfig->tamperDriveStrength
 *     defaultConfig->tamperSlewRate
 *     defaultConfig->secureRegisterFile
 *     defaultConfig->prescaler
 * @endcode
...
/*!
 * @brief Write to DryIce Control Register.
 *
 ...
 * @return kStatus_Success when operation completes sucessfully
 */
status_t DRYICE_Configure(DRY_Type *base, const dryice_config_t *config);
...
/*!
 * @brief Write active tamper register(s)
 *
...
/*!
 * @brief Get default values for tamper pin configuration
 *
 * This function fills the give structure with default values for tamper pin and glitch filter configuration.
 * The default values are:
 * @code
...
/*!
 * @brief Write tamper pin configuration
 *
 ...
 * @return kStatus_Success when operation completes sucessfully
 */
status_t DRYICE_PinConfigure(DRY_Type *base, const dryice_pin_config_t *pinConfig, uint32_t pinSelect);

/*!
 * @brief Read Secure Key Register(s)
 *
...
/*!
 * @brief Write Secure Key Register(s)
 *
...
/*!
 * @brief Write to Tamper Enable Register
 *
...
/*!
 * @brief Write to Tamper Seconds Register
 *
...
/*!
 * @brief Reads Tamper Seconds Register
 *
...
/*!
 * @brief Write to DryIce Lock Register
 *
...
/*!
 * @brief Write to DryIce Secure Key Lock Registers
 *
...
/*!
 * @brief Write to DryIce Access Control Registers
 *
